...
<style>
    /* Estilo para a largura dos campos */
    .form-control {
        width: 200px;
        margin: 0 auto;
    }
...
<div class="container">
    <form action="{{ route('usuarios.update', ['user' => $user->USUARIO_ID]) }}" method="post" class="text-center">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control mx-auto" id="exampleInputEmail1" aria-describedby="emailHelp" name="USUARIO_NOME" value="{{$user->USUARIO_NOME}}" required>
            <small id="emailHelp" class="form-text text-muted"></small>
        </div>

        <div class="form-group">
            <label for="exampleInputPassword1">E-mail:</label>
            <input type="email" class="form-control mx-auto" id="exampleInputPassword1" name="USUARIO_EMAIL" value="{{$user->USUARIO_EMAIL}}" required>
        </div>  
<p></p>
<p>&nbsp</p>
        <form>
            <button id="saveEditor" type="submit" class="btn btn-warning btn-block buttonLogin fixed-width-button">Salvar</button>
        </form>
                ...
                <div class="m-section">
                    ...
                    <div class="m-section__content">
                        <ul class="m-nav m-nav--inline m-icons">
                            <li class="m-nav__item">
                                <a href="https://www.facebook.com/Ticket Bravo" class="m-nav__link" title="Facebook"
                            ...
                            <li class="m-nav__item">
                                <a href="https://instagram.com/Ticket Bravo" class="m-nav__link" title="Instagram"
                                    target="_blank" tabindex="0">
                            ...
                            <li class="m-nav__item">
                                <a href="https://www.youtube.com/Ticket Bravo" class="m-nav__link" title="Youtube"
                                    target="_blank" tabindex="0">
                            ...
                            <li class="m-nav__item">
                                <a href="https://open.spotify.com/user/Ticket Bravo" class="m-nav__link" title="Spotify"
                                    target="_blank" tabindex="0">
                            ...
                            <li class="m-nav__item">
                                <a href="https://t.me/s/Ticket BravoIngressos" class="m-nav__link" title="Telegram"
                                    target="_blank" tabindex="0">
