...
<div class="principal-poy">
  <div style="margin-left:500px; font-size:20px;">
    <h1 style="padding-left:100px;"> Informações de Usuário </h1>
    <table id="tabelaPerfil">
      <tr style="border:1px solid black;">
        <th style="padding-right:50px;">Nome de Usuário</th>
        <th  style="padding-right:50px;">E-mail</th>
        <th  style="padding-right:50px;">CPF</th>
      </tr>
