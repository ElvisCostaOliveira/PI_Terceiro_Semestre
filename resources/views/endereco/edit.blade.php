    ...
    <section>
        ...
        <div class="tabela-ty">
            <form action="{{route('endereco.store')}}" method="POST">
                ...
                <button type="submit" class="btn btn-warning btn-block buttonLogin fixed-width-button mx-auto" style="width: 300px;">Atualizar</button>
