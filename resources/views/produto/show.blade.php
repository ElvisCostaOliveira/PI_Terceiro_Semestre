...
<body class="m-page--wide m-header--fixed m-header--fixed-mobile m-footer--push m-aside--offcanvas-default "
            ...
            <div id="contents" class="m-grid__item m-grid__item--fluid m-wrapper">
                ...
                <div class="m-content">
                    ...
                    <div class="m-portlet m-portlet--mobile m-portlet--responsive-mobile">
                        <div class="m-portlet__head--fit">
                            <img src="{{$produto->ProdutoImagem[0]->IMAGEM_URL}}" alt="{{$produto->PRODUTO_NOME}}"
                ...
                <div class="m-accordion m-accordion--bordered" id="m_accordion_event" role="tablist">
                    ...
                    <div class="m-accordion__item">
                        <div class="m-accordion__item-head collapsed" role="tab" id="m_accordion_event_item_5_head"
                            data-toggle="collapse" href="#m_accordion_event_item_5_body" aria-expanded="false">
                            <span class="m-accordion__item-icon">
                                <i class="flaticon-list-2"></i>
                            </span>
                            <span class="m-accordion__item-title">Descrição</span>
                            <span class="m-accordion__item-mode"></span>
                        </div>
                        <div class="m-accordion__item-body collapse" id="m_accordion_event_item_5_body" role="tabpanel"
                            aria-labelledby="m_accordion_event_item_5_head" data-parent="#m_accordion_event">
                            <div class="m-accordion__item-content">
                                <div class="m-scrollable" data-scrollbar-shown="true" data-scrollable="true"
                                    data-height="380">
                                    <p style="text-align: justify;"><span
                                            style="font-size: small;"><strong>{{$produto->PRODUTO_NOME}}</strong></span>
                                    </p>
                                    <p style="text-align: justify;"><span
                                            style="font-size: small;">{{$produto->PRODUTO_DESC}}</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script
        type="text/javascript">window.NREUM || (NREUM = {}); NREUM.info = { "beacon": "bam.nr-data.net", "licenseKey": "NRJS-f2d15bd9e96e98a917d", "applicationID": "1126828151", "transactionName": "MwADMEtVC0FSVBBZXApKIAdNXQpcHEQNRFZLABcBV0AKQRxTAURSCA0E", "queueTime": 0, "applicationTime": 40, "atts": "H0cARgNPGE8=", "errorBeacon": "bam.nr-data.net", "agent": "" }</script>
